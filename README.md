...
|------|-------------------|
| **AI/ML** | Python, TensorFlow, scikit‑learn, NLP, LLMs |
| **Web Dev** | Django, React, JavaScript, HTML/CSS |
| **Vibe Coding** | Claude, ChatGPT, Cursor, GitHub Copilot |
...
- Cloud hosting (Railway, Netlify, AWS basics)  
